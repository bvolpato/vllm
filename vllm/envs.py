...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Disable sparse MLA and its indexer so models can use a dense MLA backend.
    # This is useful on devices without a compatible sparse MLA kernel.
    "VLLM_MLA_FORCE_DENSE": lambda: bool(int(os.getenv("VLLM_MLA_FORCE_DENSE", "0"))),
